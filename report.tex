...
\begin{document}
\ifenglish\else\frenchspacing\fi
...
\begin{biosketch}
\begin{center}
  \includegraphics[width=1.5in]{photo/profile.jpeg}
\end{center}
นายกมลพัฒน์ สุนทรพงศ์ เข้าศึกษาภาควิชาวิศวกรรมคอมพิวเตอร์ เมื่อสิงหาคม 2562 มีความสนใจในด้านของ
IT Infrasturcture และระบบ Cloud Computing ระหว่างศึกษาได้มีโอกาสสหกิจศึกษาที่บริษัทเอสซีบี เทคเอกซ์ จำกัด 
ในตำแหน่ง DevOps Engineer
\end{biosketch}
\fi % \ifproject
\end{document}
