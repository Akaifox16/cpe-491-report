...
\begin{equation}
  \mathit{penalty'_\mathit{all\_unpicked}} < \mathit{penalty_\mathit{all\_unpicked}}
\end{equation}
%
เมื่อขยายพจน์ออกมาจะได้ดังอสมการ
\begin{equation}
  \sum_{\mathit{attr} = 1}^{n} \mathit{weight_\mathit{attr\_picked}} 
  < \sum_{\mathit{attr} = 1}^{n} \mathit{weight_\mathit{attr\_unpicked}}
\end{equation}
โดยที่
\begin{align}
  \sum_{\mathit{attr} = 1}^{n} \mathit{weight_\mathit{attr\_picked}} &= 
