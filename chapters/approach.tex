...
\end{enumerate}
ซึ่งการจะปรับ $weight_{attr}$ นั้นต้องอ้างอิงจากข้อจำกัดที่ว่าค่า penalty ของ weight ที่ต้องปรับลดหรือ $penalty_{attr-picked}$ 
จะต้องไม่มากไปกว่าค่า penalty ของ weight ที่ถูกเปรีบเทียบด้วยหรือ $penalty_{attr-compare}$

\subsubsection{การหาค่า weight} 
