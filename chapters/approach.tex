...
\begin{enumerate}
  ...
  \item หาคู่อันดับ $(x',y')$ ที่มีระยะทางแบบยูคลิด~\cite{euclid-dist}น้อยที่สุดจาก $(x,y)$ หรือก็คือค่าของ$(\sqrt{(x-x')^2 + (y-y')^2})$มีค่าน้อยที่สุดนั่นเอง 
  แล้วให้ $(x',y')$ ของผู้ใช้คนนั้นคู่เป็นเพื่อนร่วมห้อง
\end{enumerate}

\section{Features}
% \CIreply{ระบุว่าเป็น wireframes ไม่ใช่ actual UI}
ต่อไปจะเป็นการอธิบายการทำงานของแต่ละระบบ และรูปภาพตัวอย่างต่อไปนี้เป็นเพียง wireframe เท่านั้นไม่ใช่ user interface จริงๆของระบบจริง
\subsection{End-user}
\begin{enumerate}
...
\begin{enumerate}
  ...
  % \CIreply{ตรงนี้ต้องให้ผู้จัดการหอพักเข้ามาทำไหม}
  \begin{figure}[h]
  \begin{center}
  ...
  \item ระบบจัดการไฟล์ที่ใช้ในการจัดการระบบลงทะเบียน: ให้ผู้ดูแลระบบสามารถเข้ามาดาวน์โหลดไฟล์ที่ใช้ในการจัดการระบบฐานข้อมูล
        เช่น ไฟล์รูปแบบการตั้งค่าห้องพักที่จะเปิดให้ลงทะเบียน ไฟล์รูปแบบที่ใช้ในการเพิ่มหอพักในฐานข้อมูล เป็นต้น ซึ่งไฟล์ทั้งหมดจะเป็นไฟล์สกุล .csv
  % \CIreply{ยกตัวอย่างไฟล์ที่ควรจะต้องดาวน์โหลดได้}
  \begin{figure}[h]
  \begin{center}
