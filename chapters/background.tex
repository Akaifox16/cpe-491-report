...
แต่จะเปลี่ยนเป็นหาวิธีประมาณการแทน\CIreply{why?}

\subsection{Stable roommates problem with triple rooms}
\cite{srpnp}
จาก\CI{บทพิสูจน์}{?} ข้างต้นจึงสรุปได้ว่า stable roommate problem ที่ 1 ห้องมีมากกว่า 2 คนนั้น
